      ...
      <div className="max-w-screen-xl h-auto mx-auto px-6 mt-16 flex flex-col mdl:flex-row justify-between items-center">
        ...
        <div className="w-full mdl:w-1/2">
          <motion.h1
            ...
            className="font-extrabold text-transparent text-2xl mdl:text-3xl lg:text-5xl mt-2 lg:mt-0 text-center mdl:text-left bg-clip-text bg-gradient-to-r from-[#004165] via-[#772432] to-[#772432] font-titleFont"
          >
            Midas Toastmasters Club
          </motion.h1>
          <motion.p
            initial={{ x: 100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
          ...
          >
            <div className="w-full lg:flex gap-4">
              <div className="w-full mdl:w-auto flex items-center justify-center mdl:justify-start">
                <BsTelephone className="text-[#004165] text-[30px] lg:text-[50px]" />
              </div>
